...
instrtype=plain
subset=all
for modelname in "gpt2-xl" "EleutherAI/pythia-2.8B"
do
    torchrun --nnodes 1  --nproc_per_node 1  scripts/sft_gpt2.py\
        ...
        --learning_rate 1e-5\
        --seq_length 512\
        --output_dir /projects/tir6/general/sachink/personalized-LM/2023/models/0923/sft/$instrtype_$subset_$modelname/
done