...
torchrun --nnodes 1  --nproc_per_node 1 scripts/reward_modeling_llama.py --model_name="/projects/tir6/general/sachink/personalized-LM/2023/llama/hf_model-7B" --output_dir /projects/tir6/general/sachink/personalized-LM/2023/models/0923/reward_models
