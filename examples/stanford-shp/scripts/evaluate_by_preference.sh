...
python evaluation/evaluate_by_preference.py\
    ...
    --generations_file1 outputs/top_p/rlhf_new_flan-t5-large-contextualized-step-$1.txt\
...
python evaluation/evaluate_by_preference.py\
    --reward_model_name $reward_model_name\
    --generations_file1 outputs/top_p/rlhf_new_flan-t5-large-contextualized-step-$1.txt\
    --generations_file2 outputs/top_p/rlhf_new_flan-t5-large-subredditname-step-$1.txt

python evaluation/evaluate_by_preference.py\
    --reward_model_name $reward_model_name\
    --generations_file1 outputs/top_p/rlhf_new_flan-t5-large-contextualized-step-$1.txt\
    --generations_file2 outputs/top_p/rlhf_new_flan-t5-large-plain-step-$1.txt
